            ...
            <template v-if="!this.user.id">
              <div class="input-group">
                <b-form-input
                  ...
                  type="text"
                ></b-form-input>
                <label for="order-lastName" :class="{ hasValue: lastName }">{{
                  $t("labels.last_name")
                }}</label>
              </div>
              <div class="input-group">
                <b-form-input
                  ...
                  type="text"
                ></b-form-input>
                <label for="order-firstName" :class="{ hasValue: firstName }">{{
                  $t("labels.first_name")
                }}</label>
              </div>
              <div class="input-group">
                <b-form-input
                  ...
                  type="email"
                ></b-form-input>
                <label for="order-email" :class="{ hasValue: email }"
                  >Email</label
                >
              </div>
            </template>
...
export default {
  ...
  methods: {
    ...
    selectPayment(payment) { //Проверка на оплату
      if (this.userPayment === "Оплата картой") {
